...
/**
 * Configure the linkedin URL element
 * Filters: Trim
 * Validators: Required
 */
$linkedin = new Quform_Element('linkedin', 'Linkedin URL');
$linkedin->addFilter('trim');
$form->addElement($linkedin);

/**
 * Configure the resume element
 * Filters: Trim
 * Validators: Required
 */
$resume = new Quform_Element_File('resume');
$resume->getFileUploadValidator()->setRequired(true)->setMaximumFileSize(10485760);
$form->addElement($resume);

/**
 * Configure the coverletter element
 * Filters: Trim
 * Validators: Required
 */
$coverletter = new Quform_Element_File('coverletter');
$coverletter->getFileUploadValidator()->setRequired(false)->setMaximumFileSize(10485760);
$form->addElement($coverletter);
 ...
 * Validators: Required
 */
$message = new Quform_Element('message', 'In a Few Words');
