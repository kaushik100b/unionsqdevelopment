...
(function ($) {
	...
	$window.on('scroll', function () {
		...
		var headerButton = $('header button.btn');
		var navButton = $('.nav-button a');
		var isServicePage = window.location.pathname.includes('services.html');
		var isFullStackPage = window.location.pathname.includes(
			'services-full-stack-development.html'
		);
		var isBackEndPage = window.location.pathname.includes(
			'services-back-end-development.html'
		);
		var isFrontEndPage = window.location.pathname.includes(
			'services-front-end-development.html'
		);
		var isMobileAppPage = window.location.pathname.includes(
			'services-mobile-app-development.html'
		);
		var isContactUsPage =
			window.location.pathname.includes('contact-us.html');
		var isOurProcessPage =
			window.location.pathname.includes('our-process.html');
		var isAboutUsPage = window.location.pathname.includes('about-us.html');

		var isCaseStudiesPage =
			window.location.pathname.includes('case-studies.html');
		...
		if (scroll <= 50) {
			...
			if (
				...
				darklogo.attr('src', 'img/logos/unionlogo.png');
				innerlogo.attr('src', 'img/logos/logo-white2.png');
			}

			// Only for Index Page: Restore to original white and remove hover effect
			if (isIndexPage) {
				headerButton
					.removeClass('btn-outline-secondary btn-hover-2')
					.addClass('btn-outline-light text-white');
				navButton
					.removeClass(
						'btn-outline-secondary btn-hover-2 btn-outline-success'
					)
					.addClass('btn-outline-light text-white');
			} else {
				...
				navButton
					.removeClass('btn-outline-light custom-button-hover')
			...
			if (
				...
				darklogo.attr('src', 'img/logos/logo-white2.png');
				if ($window.width() >= 992) {
					innerlogo.attr('src', 'img/logos/unionlogo.png');
				}
			}

			// Restore default scroll styles for buttons
			headerButton
				.removeClass('btn-outline-light text-white')
				.addClass('btn-outline-secondary btn-hover-2');
			navButton
				.removeClass('btn-outline-light text-white')
				.addClass('btn-outline-success btn-hover-2 opacity-1');
		}
	});
